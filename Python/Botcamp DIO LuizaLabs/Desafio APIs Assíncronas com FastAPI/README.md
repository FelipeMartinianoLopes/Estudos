...
Neste desafio projetamos e implementamos uma API RESTful assíncrona usando FastAPI para gerenciar operações bancárias de depósitos e saques, vinculadas a contas correntes. 

## Objetivos e Funcionalidades

O objetivo deste desafio foi desenvolver uma API com as seguintes funcionalidades:
